  ...
  return (
    ...
    >
      ...
      >
        ...
        transition={{duration: 0.5, delay: 0.3}}
        >
            <motion.div className='w-64 sm:w-80 rounded-3xl max-w-none mx-auto lg:mx-0'
            ...
            >
                <p className='mb-10 max-w-2xl mx-auto lg:mx-0 font-Ovo text-center lg:text-left'>
                ...
                >
                    {infoList.map(({icon, iconDark, title, description}, index)=>(
                        <motion.li className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover
                ...
                >
                  {toolsData.map((tool, index)=>(
                    <motion.li className='flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:-translate-y-1 duration-500'
                    key={index}
