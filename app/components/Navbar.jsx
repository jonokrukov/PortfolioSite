...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
  ...
  /* Sidebar menu show/hide functions */
  ...
  /* Changes navigation bar when scrolling page */
  useEffect(()=>{
  ...
  return (
    ...
    <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white/50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" : ""}`}>
        <a href="#top">
            <Image src={assets.krukov_logo} alt ="" className= 'w-28 alt="" cursor-pointer mr-14'/>
        </a>
        ...
        <div className='flex items-center gap-4'>
          ...
          <button onClick={()=> setIsDarkMode(prev => !prev)}>
            ...
            dark:border-white/50'>Contact <Image src={isDarkMode ? assets.arrow_icon_dark : assets.arrow_icon} alt="" className='w-3'/> </a>
